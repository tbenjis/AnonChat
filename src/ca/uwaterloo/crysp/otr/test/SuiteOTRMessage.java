...
public class SuiteOTRMessage extends TestSuite
{
	public SuiteOTRMessage(TestHarness h)
	{
		super(h);
		createSuite();
	}
	...
	private class TestCaseReadMessage extends TestCase
	{
		...
		{
			return "Read an OTR Data Message from InBuf stream";
		}
	}
	...
	private class TestCaseWriteMessage extends TestCase
	{
		...
		public String getDesc()
		{
			return "Write an OTR Data Message to OutBuf stream";
		}
	}
}
